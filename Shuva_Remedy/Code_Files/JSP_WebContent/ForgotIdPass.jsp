...
<body>
	<div id="loginHeader"><h2>Reset in Remedy Doctor System</h2></div>
	<hr>
		<p id="resetLink" onclick="resetPwd()">Forget/Reset</p> <a href="Login.jsp">Back</a>
	<hr>
	<div id="register">
		<h4>REGISTER</h4>
		<form name="register" method="post" action ="Login.jsp" onsubmit="return validateRegisterForm();">
	...
	<div id="reset">
		<h4>RESET</h4>
		<form name="reset" method="post" action ="ForgotPasswordScreen" onsubmit="return validateResetForm();">
		...
		<table id="rrTable">
			...
			<tr>
				...
				<td><input type="text" name="quesOne" onfocus="clearResetError()" /></td>
			</tr>
			<tr>
				<td>What is your favorite car model?*</td>
				<td><input type="text" name="quesTwo" onfocus="clearResetError()" /></td>
			</tr>
			<tr>
				<td />
				<td><input type="submit" name="Show Password" /></td>
			</tr>
		</table>
		</form>
	</div>
