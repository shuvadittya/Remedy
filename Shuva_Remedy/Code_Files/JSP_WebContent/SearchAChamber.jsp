...
<title>Remedy Doctor System - Chamber Details</title>
</head>
<body>
    <div id="loginHeader"><h2>Remedy Doctor System - Chamber Search</h2></div>
	...
	<form action="SearchChamberServlet" method="post"> 
		<table align="center">
				<%
