...
<h3 align='center'>Chamber Details is Successfully Added!</h3>
 
 <table align="center">
			<tr>
			<td><input type=button onClick="parent.location='AddNewChamber.jsp'" value='Add More Chamber'></td>
			</tr>
			<tr>
			<td><input type=button onClick="parent.location='SearchAChamber.jsp'" value='Search A Chamber'></td>
			</tr>
			<tr>
