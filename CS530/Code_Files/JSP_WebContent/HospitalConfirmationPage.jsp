...
<h3 align='center'>Hospital Details is Successfully Added!</h3>
 
 <table align="center">
			<tr>
			<td><input type=button onClick="parent.location='AddNewHospital.jsp'" value='Add More Hospital'></td>
			</tr>
			<tr>
			<td><input type=button onClick="parent.location='SearchAHospital.jsp'" value='Search A Hospital'></td>
			</tr>
			<tr>
