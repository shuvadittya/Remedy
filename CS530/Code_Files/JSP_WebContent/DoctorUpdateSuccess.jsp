...
<h3 align='center'>Doctor Details is Successfully Updated!</h3>
 
<table align="center">
			<tr>
			<td><input type=button onClick="parent.location='AddNewDoctor.jsp'" value='Add More Doctor'></td>
			</tr>
			<tr>
			<td><input type=button onClick="parent.location='SearchADoctor.jsp'" value='Search A Doctor'></td>
			</tr>
			<tr>
